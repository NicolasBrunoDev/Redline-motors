        ...
        <div className='py-8'>
            <div className='container mx-auto'>
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
                    {/*Primera columna*/}
                    <div className='col-span-2 py-10 pl-5 bg-gradient-to-br from-black/90 to-black/70 text-white rounded-3xl relative h-[320px]
                flex items-end'>
                        <div>
                            <div className='mb-4'>
                        ...
                        <img src={Car2} alt="" className='w-[320px] absolute top-1/2 -translate-y-1/2 -right-0' />
                    </div>
                    {/*Segunda columna*/}
